...
const EVERY_DOWN_5 = {
  ...
  officials: [
    { mark: 'R', at: { across: 12.5, down: -11 }, highlight: true },
  ...
  notes: [
    ...
    { text: "passing-arm side · 10–12 back", at: { across: 4, down: -14.5 } },
    { text: "5–7 off B's line", at: { across: -7.4667, down: 7.75 }, anchor: 'end' },
    { text: "20–25 off the line", at: { across: 3, down: 16.5 }, anchor: 'end' },
  ],
};
